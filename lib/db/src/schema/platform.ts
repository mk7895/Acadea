...
export const menteeProfilesTable = pgTable(
  "mentee_profiles",
  {
    ...
    storageLimitExceededAt: timestamp("storage_limit_exceeded_at"),
    storageCleanupDueAt: timestamp("storage_cleanup_due_at"),
    storageLastAutoCleanupAt: timestamp("storage_last_auto_cleanup_at"),
    googleDriveFolderId: text("google_drive_folder_id"),
    googleDriveFolderUrl: text("google_drive_folder_url"),
