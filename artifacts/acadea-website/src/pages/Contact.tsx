                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:kontakt@acadea.pl" className="text-gray-300 hover:text-white transition-colors">kontakt@acadea.pl</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+48123456789" className="text-gray-300 hover:text-white transition-colors">+48 123 456 789</a>
                    </div>
                  </div>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-700">Imię i nazwisko</FormLabel>
                          <FormControl>
                            <Input placeholder="Jan Kowalski" className="bg-gray-50 border-gray-200" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-700">Adres email</FormLabel>
                          <FormControl>
                            <Input placeholder="jan@example.com" type="email" className="bg-gray-50 border-gray-200" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700">Numer telefonu</FormLabel>
                        <FormControl>
                          <Input placeholder="+48 123 456 789" type="tel" className="bg-gray-50 border-gray-200" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700">Wiadomość / Jakie kraje Cię interesują?</FormLabel>
                        <FormControl>
                          <Textarea 
                  ...
                  <Button type="submit" size="lg" className="w-full md:w-auto px-8 rounded-full">
                    Wyślij wiadomość
                  </Button>
                </form>
              </Form>
